...
public class Controller3 : PlayInfo
{
    ...
    public static GameObject SpawnPreFab3;
    ...
    protected virtual void Start()
    {
        ...
        if (SpectatorPreFab)
        {
            SpectatorActor = Factory3(SpectatorPreFab, Vector3.zero, new Quaternion(), this);
        }
    ...
    public GameObject RequestSpawn()
    {
        ...
        return SpawnSystem.Self.RequestSpawn(this, SpawnPreFab3);
    }
    ...
    public GameObject RequestSpawnAt(Transform SpawnPoint)
    {
        ...
        GameObject Pawn = Factory3(SpawnPreFab3, SpawnPoint.position, SpawnPoint.rotation, this);
        PossesPawn(Pawn);
        return Pawn;
    }
