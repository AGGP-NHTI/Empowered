...
public class Controller4 : PlayInfo
{
    ...
    public static GameObject SpawnPreFab4;
    ...
    protected virtual void Start()
    {
        ...
        if (SpectatorPreFab)
        {
            SpectatorActor = Factory4(SpectatorPreFab, Vector3.zero, new Quaternion(), this);
        }
    ...
    public GameObject RequestSpawn()
    {
        ...
        return SpawnSystem.Self.RequestSpawn(this, SpawnPreFab4);
    }
    ...
    public GameObject RequestSpawnAt(Transform SpawnPoint)
    {
        ...
        GameObject Pawn = Factory4(SpawnPreFab4, SpawnPoint.position, SpawnPoint.rotation, this);
        PossesPawn(Pawn);
        return Pawn;
    }
