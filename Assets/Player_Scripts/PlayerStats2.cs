...
public class PlayerStats2 : Controller2
{
    ...
    {
        AddAxis("P2Horizontal", P2Horizontal);
        AddAxis("P2Vertical", P2Vertical);
        AddButton("P2Fire1", P2Fire1);
        AddButton("P2Fire2", P2Fire2);
        AddButton("P2Fire3", P2Fire3);
        AddButton("P2Fire4", P2Fire4);
